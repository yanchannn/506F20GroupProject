...
Similarly, we can interpret the **nonlinear combination** of regression coefficients, $exp(x1)/exp(x2)$ as the ratio of the expected value of the response variable.

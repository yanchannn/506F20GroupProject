...
## **Model fitting**
Since the response variable `suicides_no` is count based, we have fitted Poisson regression model with `year`, `sex`, `age`, `gdp_per_capita` as the predictors. Basically, we want to maximize the likelihood function below

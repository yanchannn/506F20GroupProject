...
Similarly, we can interpret the **nonlinear combination** of regression coefficients, $exp(x1/x2)$ as the ratio of the expected value of the response variable, where $x1$ and $x2$ are predictor variables. We can also estimate
the coefficient of $exp(x1*x2)$.
